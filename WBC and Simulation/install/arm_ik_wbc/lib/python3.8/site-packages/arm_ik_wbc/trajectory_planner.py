...
class TrajectoryPlanner:
    ...
    def generate_trajectory(self, current_dict, target_dict):
        ...
        #print("Finding milestones for each frame ({} milestones)".format(self.n_of_control_frames))
        ...
        # print("Finding trajectories for each frame")
        for i in range(self.n_of_control_frames):
    ...
    def run_stored_trajectory(self, target_dict, step):
        ...
        for i in range(self.n_of_control_frames):
            #print(self.traj_list_pos[i].eval(step))
