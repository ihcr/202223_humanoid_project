...
class CoMCartesianTask:
    ...
    def __init__(self, task_weight, task_gain):
        ...
        #f = open('/home/will/Documents/simulation_test_1.csv', 'w')
    ...
    def CoMCartesianFindAb(self, robot_model, robot_data, joint_config, target_pos, dt):
        ...
        #current_CoM_pos = self.robot_data.com[0].reshape(3,1)
        #print(current_CoM_pos)
        #boxId = pybullet.loadURDF("/home/will/humanoid_ws/src/arm_ik_wbc/models/marker.urdf", current_CoM_pos, pybullet.getQuaternionFromEuler([0,0,0]), useFixedBase = True)
        # Find task A and b
